...
// Función para validar el formulario de contactanos y mostrar el mensaje de éxito
(function() {
    'use strict';
    ...
    form.addEventListener('submit', function(event) {
        ...
        if (form.checkValidity() === false) {
            ...
            document.getElementById('successMessage').innerText = "Nos comunicaremos contigo lo más pronto posible : )!";
            form.reset();  // Reinicia el formulario
        }

        // Añade la clase de validación
